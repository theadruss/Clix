// Firestore seeding script for CampusConnect
// Creates sample collections: users, clubs, events, proposals, payments
// IMPORTANT: Set SERVICE_ACCOUNT_JSON environment variable before running
...
if (!serviceAccountJson) {
  console.error('ERROR: Set SERVICE_ACCOUNT_JSON environment variable with the service account JSON');
  console.error('Example: $env:SERVICE_ACCOUNT_JSON = \'{"type":"service_account",...}\'');
  process.exit(1);
}
